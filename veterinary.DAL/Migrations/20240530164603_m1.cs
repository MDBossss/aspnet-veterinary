        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicationPrescription_Medication_MedicationsID",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Mary", "Jane", "7224567892" }
                });

            migrationBuilder.InsertData(
                table: "Pets",
                columns: new[] { "ID", "BirthDate", "Breed", "Discriminator", "Name", "OwnerID", "Weight" },
                values: new object[] { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Labrador", "Dog", "Buddy", 1, 32.0 });

            migrationBuilder.InsertData(
                table: "Pets",
                columns: new[] { "ID", "BirthDate", "Discriminator", "Name", "OwnerID", "Weight", "Wingspan" },
                values: new object[] { 2, new DateTime(2024, 5, 30, 18, 46, 2, 975, DateTimeKind.Local).AddTicks(2467), "Bird", "Koko", 2, 3.7000000000000002, 15.5 });
